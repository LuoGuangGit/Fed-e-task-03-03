        ...
        <div class="col-md-6 offset-md-3 col-xs-12">
          ...
          <form @submit.prevent="onSubmit">
            <fieldset class="form-group" v-if="!isLogin">
              <input v-model="user.username" class="form-control form-control-lg" type="email" placeholder="Your Name" required>
            </fieldset>
  ...
  methods: {
    async onSubmit () {
      try {
        ...
        this.isLogin && this.$store.commit('setUser', data.user);
